...
-- No order, position, confirmation, execution switch, or credential is changed.
...
comment on function public.get_copy_worker_context() is
  'Bounded worker context with canonical resume-aware observation guards; confirmed fills never relock a later position.';
